    ...
    <>
      ...
      >
        ...
        <Box sx={{ maxWidth: "600px", color: colors.blue, my: 2 }}>
          مع التوسعات التي تقوم بها الشركة، نتطلع دائماً لإضافة المزيد من
          القيادات البراقة لفريق العمل الذي يضم أكثر من 1300 موظفاُ. والشركة
          تتمتع بمعدل دوران منخفض جداً للعمالة مع استمرار العديد من مديريها في
          العمل منذ نشأتها. نحن نؤمن بأهمية تنمية وتطوير رأس المال البشري من أجل
          تحقيق نمونا المنشود كأفراد وكفريق عمل وكمؤسسة. إن كنت ترغب في الانضمام
          إلينا يرجى ملء النموذج
        </Box>
