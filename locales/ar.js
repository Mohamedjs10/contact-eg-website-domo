  ...
  footer: {
    ...
    section_b: {
      ...
      financial_services_list1: [
        { name: "تمويل السيارات", url: "/" },
        { name: "تمويل النقل", url: "/" },
        { name: "تمويل تسوق", url: "/" },
        { name: "تمويل التعليم", url: "/" },
        { name: "تمويل إشتراكات الاندية", url: "/" },
        { name: "تمويل تصميم و تشطيب", url: "/" },
      ],
      financial_services_list2: [
        { name: "تمويل أفراح و مناسبات", url: "/" },
        { name: "تمويل عقاري", url: "/" },
        { name: "وساطة تأمينية", url: "/" },
        { name: "تخصيم", url: "/" },
        { name: "تأجير تمويلي", url: "/" },
        { name: "تمويل الاخضر", url: "/" },
      ],
