...
export default {
  ...
  footer: {
    ...
    section_b: {
      ...
      other_services_list: [
        ...
        { name: "مدفوعات الكترونية", url: "/e-payment" },
        { name: "برنامج العملاء", url: "/rewards" },
        { name: "إستثمار و ادخار ", url: "/investment" },
      ],
      contact: "كونتكت",
      contact_list: [
        { name: "عن كونتكت", url: "/about" },
        { name: "شركتنا", url: "/our-brands" },
        { name: "أخبار كونتكت", url: "/media" },
        { name: "عروض كونتكت", url: "/contact-offers" },
        { name: "المدونة", url: "/blog" },
        { name: "الإستدامة", url: "/sustainability" },
      ],
      company: "الشركة",
      company_list: [
        { name: "وظائفنا", url: "/careers" },
        {
    ...
    feature: [
      {
        ...
        title: "لكن لا بد أن أوضح لك أن كل",
        text: "لكن لا بد أن أوضح لك أن كل هذه الأفكار المغلوطة حول استنكار  النشوة وتمجيد الألم نشأت بالفعل، وسأعرض لك التفاصيل لتكتشف حقيقة وأساس تلك السعادة البشرية، فلا أحد يرفض أو يكره أو يتجنب الشعور بالسعادة، ولكن بفضل هؤلاء الأشخاص الذين لا يدركون بأن السعادة لا بد أن نستشعرها بصورة أكثر عقلانية ومنطقية فيعرضهم هذا لمواجهة الظروف الأليمة، وأكرر بأنه لا يوجد من يرغب في الحب ونيل المنال ويتلذذ بالآلام، الألم هو الألم ولكن نتيجة لظروف ما قد تكمن السعاده فيما نتحمله من كد وأسي.",
        img: "/images/sustainability-feature1.svg",
      },
      {
        id: "2",
        title: "لكن لا بد أن أوضح لك أن كل",
  ...
  contact_homes: {
    cover: {
      ...
      color: "#2D9A8F",
      title1: "كونتكت هومز",
      title2: "بداية جديدة لحياة متكاملة",
      description: `الان من خلال الشراكة بين شركة كونتكت, شركة التمويل الأولى في مصر، و شركة كولدويل بانكر رائدة التسويق العقاري، اصبح بإمكانك الاستفادة من عالم لا نهائي من المزايا و العروض التي توفر لك الحياة المتكاملة التي تحلم بها بخصومات كبيرة و أسعار خاصة. بداية جديدة لحياة متكاملة`,
    },
    section_a: {
      img: "/pages/without-advance.png",
      title: "الشروط الخاصة ببرنامج “كونتكت هومز",
      body: `أن يكون عميل حالي لدى كولدول بنكر`,
    },
    section_b: {
      img: "/pages/without-advance.png",
      title:
        "استمتع بعالم من المزايا الحصرية عند انضمامك إلى “Coldwell Banker Star Club”",
      body: [
        "نموذج تصميم ثلاثي الأبعاد مجاناً لغرفة المعيشة أو غرفة النوم أو أحد أقسام غرفة الاستقبال",
        "50% خصم على نموذج التصميم ثنائي الأبعاد وثلاثي الأبعاد عند التعاقد مقدمة من RD Design",
        "تمويل عقاري يصل الى 5 ملايين جنيه من كونتكت",
        "تمويل تسوق يصل الى 500 الف جنيه من كونتكت",
        "عروض حصرية وخصومات خاصة على دهانات جوتن، ايكيا و تكييفات كاريير",
      ],
    },
    section_c: {
      img: "/pages/without-advance.png",
      title:
        "مزايا وخصومات حصرية لعملاء”Coldwell Banker Star Club” مقدمة من كونتكت على",
      body: [
        "التمويل عقاري",
        "التسوق",
        "تمويل التشطيب",
    ...
    section_d: {
      ...
      title:
        "استمتع بعالم من المزايا الحصرية عند انضمامك إلى “Coldwell Banker Star Club”",
      body: [
        "تأمين منزل مجانى لمدة عام",
        "وثيقة استبدال مفتاح",
        "تأمين على الهاتف المحمول، آيباد و التلفزيون",
        "خصم 50% على قيمة تأمين المنزل الثاني (الساحل الشمالي أو العين السخنة)",
      ],
    },
  },
};
